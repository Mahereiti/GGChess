...
public class Knight extends Piece {
	...
	public ArrayList<Square> getValidMoves() {
	    ...
	    if ((row+2)<8 && (col+1)<8) {
	        if (!board[row+2][col+1].isOccupied() || !board[row+2][col+1].getPiece().getColor().equals(this.getColor())) {
	    ...
	    if ((row+1)<8 && (col+2)< 8) {
	        if (!board[row+1][col+2].isOccupied() || !board[row+1][col+2].getPiece().getColor().equals(this.getColor())) {
